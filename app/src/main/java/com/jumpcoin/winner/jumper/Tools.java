...
public class Tools {
    ...
    public static void setJump(String newLink, Activity context) {
        DataBase dataBase = new DataBase(context);
        dataBase.setJump("http://" + cut(newLink));


        context.startActivity(new Intent(context,  SuperJumper.class));
        context.finish();
    }
