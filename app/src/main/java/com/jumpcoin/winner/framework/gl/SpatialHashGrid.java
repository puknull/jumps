package com.jumpcoin.winner.framework.gl;
...
public class SpatialHashGrid {
	...
	public SpatialHashGrid(float worldWidth, float worldHeight, float cellSize) {
		...
		this.cellsPerRow = (int)(float)Math.ceil(worldWidth/cellSize);
		this.cellsPerCol = (int)(float)Math.ceil(worldHeight/cellSize);
	...
	public int[] getCellIds(GameObject obj) {
		int x1 = (int)(float)Math.floor(obj.bounds.lowerLeft.x / cellSize);
		int y1 = (int)(float)Math.floor(obj.bounds.lowerLeft.y / cellSize);
		int x2 = (int)(float)Math.floor((obj.bounds.lowerLeft.x + obj.bounds.width) / cellSize);
		int y2 = (int)(float)Math.floor((obj.bounds.lowerLeft.y + obj.bounds.height) / cellSize);
